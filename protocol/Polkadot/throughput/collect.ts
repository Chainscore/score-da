 ...
 * metrics (throughput, utilization) are computed at plot time from
 * chain_config.json.
 *
 * Outputs:
 *   1. analysis/throughput.csv       — per-block event data
 *   2. analysis/chain_config.json    — active config + governance milestones
 *   3. stdout                        — summary table
 *
 * The plotting step is separate: see plot_throughput.ts
 */
