"""NEAR DA — Generate research paper figures from daily.csv."""
...
def main():
    ...
    # Max throughput is ~59 MiB/s vs actual ~0.1 → log scale
    ...
    save(plot_cumulative(
        d, df["cumulative_daily_data_mib"], df["cumulative_daily_da_spend_usd"],
