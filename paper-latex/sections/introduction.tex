...
Polkadot uses Nominated Proof of Stake (NPoS) consensus mechanism which allows token holders to nominate entrusted validators to secure the network\cite{Overview_of_polkadot}.
...
(Data sourced from network documentation: \cite{polkadot_article}, \cite{Celestia_Overview}, \cite{Espresso:Hotshot_and_Triamisu}, \cite{NEAR_Nightshade_Scaling_Blockchain}, \cite{Avail_The_DA_Blockchain})
}
