...
\begin{table}[h!] \centering \caption{Comparative Throughput Analysis of DA Solutions} \label{tab:throughput} \setlength{\tabcolsep}{5pt} % reduce column padding 
...
\begin{table}[h!] \centering \caption{Comparative TPS Analysis of DA Solutions} \label{tab:tps} \setlength{\tabcolsep}{5pt} % reduce column padding 
    \renewcommand{\arraystretch}{1.1} % tighten row spacing 
...
\begin{table}[h!] \centering \caption{Comparative \$/MB Analysis of DA Solutions} \label{tab:cost_per_mb} \setlength{\tabcolsep}{5pt} % reduce column padding 
    \renewcommand{\arraystretch}{1.1} % tighten row spacing 
...
% (table here...)'
\begin{table}[h!] \centering \caption{Comparative Latency Analysis of DA Solutions} \label{tab:latency} \setlength{\tabcolsep}{5pt} % reduce column padding 
    \renewcommand{\arraystretch}{1.1} % tighten row spacing 
...
% (table here...)
\begin{table}[h!] \centering \caption{Comparative Block Size Analysis of DA Solutions} \label{tab:block_size} \setlength{\tabcolsep}{5pt} % reduce column padding 
    \renewcommand{\arraystretch}{1.1} % tighten row spacing 
...
% (table here...)
\begin{table}[h!] \centering \caption{Data Retrieval Latency Analysis of DA Solutions} \label{tab:data_retrieval} \setlength{\tabcolsep}{5pt} % reduce column padding 
    \renewcommand{\arraystretch}{1.1} % tighten row spacing 
...
\begin{tabular}{|p{2cm}|p{3cm}|p{2cm}|p{1cm}|}
\hline
\textbf{Network} &
\textbf{Honest Majority Requirement} &
\textbf{Validator Count (Approx.)} &
\textbf{And more...} \\
\hline
\textbf{Polkadot (ELVES)} &
$\geq \tfrac{2}{3}$ honest validators &
600 & X\\
\hline
\textbf{Celestia} &
$\geq \tfrac{2}{3}$ honest for consensus; $\geq 1$ honest full/light node for DA sampling &
100 & X\\
\hline
\textbf{Espresso (Tiramisu)} &
$\geq \tfrac{2}{3}$ honest DA committee member or fallback node &
100 & X\\
\hline
\textbf{NEAR} &
$\geq \tfrac{2}{3}$ honest validators per shard &
500 & X\\
\hline
\textbf{Avail} &
$\geq \tfrac{2}{3}$ honest for consensus; $\geq 1$ honest sampler for DA detection &
105 & X\\
\hline
\end{tabular}
\label{tab:da-security-assumptions}
\end{table}
