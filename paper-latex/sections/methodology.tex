...
We measure how on-chain congestion, gas fee surges, and payload sizes affect the overall inclusion cost.

\begin{itemize}
    \item \textbf{Test Parameters:} Network congestion, data size (1KB–1MB), gas/fee volatility
...
This measures the maximum inclusion time under stress conditions (e.g., full block utilization, network congestion).
\begin{itemize}
