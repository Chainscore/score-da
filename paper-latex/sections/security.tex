...
With 6~shards and approximately 400~validators, the per-shard committee size depends on stake distribution.
...
Avail & $f < n/3$ & TBD & BABE + GRANDPA & 20--60\,s & Variable \\
\bottomrule
\end{tabular}
\end{table*}
